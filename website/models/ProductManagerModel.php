 ...
 * This model is responsible for handling product creation, updating, and management operations.
 */

class ProductManagerModel extends AbstractModel
{
    // Get all available categories/categories
    ...
    public function addProductCategories($productId, $categories)
    {
        ...
        if (!empty($categories)) {
            ...
            foreach ($categories as $category) {
                $this->getDB()->executePrepared($query, [$productId, $category]);
            }
        }
    ...
    private function removeProductCategories($productId)
    {
